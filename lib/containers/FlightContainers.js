...
const FlightContainers = (props) => {
    ...
    return (React.createElement("div", null,
        React.createElement("div", { className: "landing-text" },
            ...
            React.createElement("button", { onClick: () => props.changeModal(props.modal), className: "button-purple" }, "+")),
        React.createElement("hr", null),
        flightInfo.map((el, i) => React.createElement(FlightInfo, { key: i, details: el })),
